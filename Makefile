...
# Main source
SRC := src/main.cpp src/helpers/ui/ThemeMgr.cpp src/helpers/common/Node.cpp src/helpers/common/CameraNode.cpp src/helpers/common/NodeMgr.cpp src/helpers/audio/AudioNode.cpp src/helpers/model/LightNode.cpp src/helpers/model/ModelNode.cpp src/Model.cpp src/RootTask.cpp ../../imgui/backends/imgui_impl_glfw.cpp ../../imgui/backends/imgui_impl_opengl3.cpp ../../imgui/imgui.cpp ../../imgui/imgui_demo.cpp ../../imgui/imgui_draw.cpp ../../imgui/imgui_tables.cpp ../../imgui/imgui_widgets.cpp $(SHADER)
